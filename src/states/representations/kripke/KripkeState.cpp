...
const KripkeWorldPointersTransitiveMapVec & KripkeState::get_beliefs_vec() const noexcept {
...
KripkeState::KripkeState(const KripkeState &other)
    : m_max_depth(other.m_max_depth), m_worlds(other.m_worlds), m_pointed(other.m_pointed),
      m_beliefs(other.m_beliefs), m_worlds_vec(other.m_worlds_vec), m_beliefs_vec(other.m_beliefs_vec) {
}